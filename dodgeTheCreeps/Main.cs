...
public class Main : Node
{
	...
	public void NewGame()
	{
		...
		HUD hud = GetNode<HUD>("HUD"); // Get HUD scene node
		hud.UpdateScore(_score); // Update score to 0
		hud.ShowMessage("Get Ready!"); // Get ready!
	}
	...
	{
		_score++;
		GetNode<HUD>("HUD").UpdateScore(_score); // Update the score
	}
